...
- 30+ models: Users, Products, Categories, Cart, Wishlist, Orders, Payments, Shipping, Reviews, Rentals, RentalChecklists, RentalPolicies, FlashSales, Referrals, CMS (Banners, Pages, Settings)
...
- **Themes**: Light, Dark, Standard (CSS variables via next-themes)
...
- Admin API client: `apps/admin/lib/api.ts` (AdminApiClient class with all CRUD methods)
